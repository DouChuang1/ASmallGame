...
//        /* 日志文件常量定义  */
//        //XML 配置文件“标签常量”
//        private const string XML_CONFIG_LOG_DRIVE_NAME = "LogDriveName";
...
//            string strPCTruePath = configMgr.AppSetting[XML_CONFIG_LOG_DRIVE_NAME] + ":\\" + configMgr.AppSetting[XML_CONFIG_LOG_PATH] + ".txt";
